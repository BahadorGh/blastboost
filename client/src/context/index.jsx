...
export const StateContextProvider = ({ children }) => {
  ...
  const getCampaigns = async (start, end) => {
    const campaigns = await contract.call("getCampaigns", [start, end]);
  ...
  const getDonations = async (pId) => {
    const donations = await contract.call("getCampaignDonators", [pId]);
